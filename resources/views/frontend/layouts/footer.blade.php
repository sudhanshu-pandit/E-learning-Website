        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>645/860A, Jankipuram Extension, Lucknow</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+091 9794940301</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Thankyou for visit our site.</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">eLEARNING.com</a>, All Right Reserved.

                        <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                        Designed By <a class="border-bottom">Sudhanshu Pandey</a><br><br>
                        Distributed By <a class="border-bottom">Mahagram</a>
                    </div>
